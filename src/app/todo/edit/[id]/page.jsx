    ...
    return (
        <div className='flex flex-col items-center justify-center min-h-screen bg-gradient-to-b from-indigo-100 via-purple-100 to-pink-100 p-5'>
            {loading ? (
                ...
                <>
                    <h2 className='text-3xl font-semibold text-purple-700 text-center mb-6'>Update Todo</h2>
                    
                    <form className='w-full max-w-md px-10 py-8 bg-white border rounded-lg shadow-lg flex flex-col gap-4' onSubmit={handleSubmit}>
                        <input 
                            type="text" 
                            name="name" 
                            value={name} 
